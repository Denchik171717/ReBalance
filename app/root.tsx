  ...
  return (
    <html lang="en" suppressHydrationWarning className={rootCssClass} style={{ colorScheme: resolvedScheme }}>
      <head>
        ...
        <meta name="description" content="Приложение для профилактики эмоционального выгорания и управления стрессом" />
